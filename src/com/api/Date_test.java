...
public class Date_test {
	...
	public static void main(String[] args) throws Exception{
		...
		System.out.println("100天以后是:"+year+"年"+month+"月"+date+"日"+hour+"时"+minute+"分"+second+"秒");
		
		SimpleDateFormat sdf1=new SimpleDateFormat("yyyy-MM-dd");
		LocalDate ldt=LocalDate.now();
		//用sdf1对象来解析等前日期加100天
		//SimpleDateFormat:parse方法将字符串解析为Date对象类
		//SimpleDateFormat:format方法将Date对象类格式化为字符串
